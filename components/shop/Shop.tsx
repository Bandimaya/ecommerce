        ...
        <div className="h-auto bg-[var(--background)] text-[var(--foreground)] font-sans relative">
            ...
            <div className="w-full max-w-[2000px] mx-auto px-4 md:px-12 py-8 relative z-10">
                <div className="flex flex-col lg:flex-row lg:gap-10 items-start">
                    {/* --- SIDEBAR (DESKTOP) --- */}
                    <aside className="hidden lg:block w-64 shrink-0 sticky top-[100px] max-h-[calc(100vh-120px)] overflow-y-auto pr-2">
                        <ShopSidebar
                            categories={categories}
                            selectedCategory={selectedCategory}
                            onSelectCategory={setSelectedCategory}
                            totalProducts={products.length}
                            getProductCount={(catId) => products.filter((p: any) => p.categories?.some((c: any) => c._id === catId)).length}
                        />
                    </aside>
                    ...
                    <div className="flex-1 min-w-0 w-full">
                        ...
                        <div className="sticky top-[60px] md:top-[80px] z-40 mb-6 md:mb-10 -mx-4 px-4 md:-mx-12 md:px-12 py-2 md:py-4 bg-[var(--background)]/95 backdrop-blur-md transition-all rounded-b-2xl md:rounded-none shadow-sm md:shadow-none">
                            <div className="flex flex-col gap-4 max-w-4xl mx-auto lg:mx-0 lg:max-w-none">
                                <div className="bg-[var(--background)] border border-[var(--border)] p-1.5 md:p-2 rounded-[10px] shadow-sm flex items-center gap-2 md:gap-4 w-full">
                                    <div className="relative flex-1 group">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-transparent pl-10 pr-4 py-2 md:py-3 text-sm md:text-base outline-none text-[var(--foreground)] placeholder:text-slate-400 group-hover:placeholder:text-slate-500 transition-colors"
                                        />
                                    </div>
                                    ...
                                    <Sheet open={isCategoryMenuOpen} onOpenChange={setIsCategoryMenuOpen}>
                                        <SheetTrigger asChild>
                                            <button
                                                className={cn(
                                                    "lg:hidden flex items-center justify-center w-10 h-10 rounded-[10px] transition-colors shrink-0",
                                        ...
                                        <SheetContent side="left" className="w-[300px] sm:w-[400px] overflow-y-auto z-[1000]">
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        <div className="relative aspect-[4/5] sm:aspect-[3/4] w-full">
                                                                            <motion.div
                                                                                className="absolute inset-0 top-0 md:top-12 rounded-[10px] border bg-white shadow-sm group-hover:shadow-xl transition-shadow duration-300 overflow-hidden flex flex-col"
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <div className="pt-3 md:pt-4 border-t border-slate-100 flex justify-between items-center mt-2">
                                                                                            ...
                                                                                            <Button size="icon" className="h-8 w-8 rounded-[10px] bg-blue-600 hover:bg-slate-900 shadow-md" onClick={(e) => handleAddToCart(e, product, countryCodeValue)} disabled={cartLoading}>
                                                                                                {cartLoading ? <Skeleton className="w-3 h-3 rounded-full bg-white/50" /> : <ShoppingCart className="w-3 h-3 text-white" />}
                                                                                            </Button>
                                                                                        </div>
                                                                                    </motion.div>
                                                                                </div>
                                                                            ...
                                                                            <motion.div
                                                                                ...
                                                                                className="absolute z-30 overflow-hidden shadow-md group-hover:shadow-xl transition-shadow duration-300 bg-white"
                                                                                variants={{
                                                                                    rest: {
            ...
            <AnimatePresence>
                {selectedProduct && (
                    <div
                        className="fixed inset-0 z-[999] flex items-center justify-center pointer-events-none pt-0 md:pt-0 px-4 md:px-4 pb-0 md:pb-0"
                    >
                        {/* BACKDROP */}
                        <motion.div
                            initial={{ opacity: 0 }}
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-h-[85vh] md:h-auto md:max-h-[90vh] md:max-w-6xl bg-white rounded-[24px] overflow-hidden shadow-2xl flex flex-col pointer-events-auto z-[1000] isolate"
