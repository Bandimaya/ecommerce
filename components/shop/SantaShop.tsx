                            ...
                            <motion.div
                                ...
                                variants={{
                                    rest: {
                                        ...
                                        borderRadius: "2rem", y: 48, scale: 1,
                                    },
                                    hover: {
                                        top: 0, left: "50%", x: "-50%",
                                        width: "240px", height: "240px",
                                        borderRadius: "1.5rem", y: -20, scale: 1.05,
                                    }
                                }}
                ...
                {selectedProduct && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center">
                        ...
                        <motion.div
                            ...
                            className="relative w-full h-[100dvh] sm:h-[85vh] sm:w-[90vw] md:max-w-6xl bg-white sm:rounded-[3rem] overflow-hidden shadow-2xl flex flex-col z-[110]"
                            onClick={(e) => e.stopPropagation()}
                        >
                            <button onClick={() => setSelectedProduct(null)} className="absolute top-8 right-8 z-50 p-3 rounded-full bg-slate-100 hover:bg-slate-200">
                            ...
                            <div className="flex flex-col md:flex-row h-full">
                                <div
                                    ...
                                    className="w-full h-[40vh] md:h-auto md:w-3/5 bg-slate-50 relative overflow-hidden cursor-crosshair"
                                ...
                                <div className="w-full md:w-2/5 flex flex-col bg-white h-full p-8 sm:p-12 overflow-y-auto">
                                    ...
                                    <div className="space-y-6 flex-1">
                                        ...
                                        {selectedProduct.outcomes.map((outcome, idx) => (
                                            <div key={idx} className="flex items-center gap-3 text-sm font-bold text-slate-600 bg-slate-50 p-4 rounded-2xl">
                                                <div className="w-2 h-2 rounded-full bg-blue-500" />
                                                {outcome}
                                            </div>
                                        ))}
                                    </div>
                                    <Button className="w-full py-8 mt-8 text-xl rounded-2xl font-black bg-slate-900 text-white hover:bg-blue-600">
