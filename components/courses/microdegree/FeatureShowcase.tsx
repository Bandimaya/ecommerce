      ...
      <div className="max-w-7xl mx-auto px-6 mb-12 md:mb-20">
        ...
        >
          ...
          <p className="text-slate-600 text-lg md:text-2xl max-w-2xl leading-relaxed">
            STEMPARK courses are a great choice because they build strong problem-solving, critical thinking, and creativity skills while preparing students for high-demand, future-ready careers. By learning science, technology, engineering, and mathematics through hands-on activities and real-world applications, students gain practical knowledge, confidence, and innovation skills that are essential in today’s digital world. STEM education also encourages curiosity, teamwork, and logical thinking, helping learners adapt to rapidly changing technologies and succeed in academics as well as modern careers.
          </p>
        </motion.div>
      </div>
