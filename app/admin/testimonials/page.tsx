                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(event) => setForm({ ...form, testimonial_type: (event.target as HTMLSelectElement).value })}
                          className="w-full p-2.5 rounded-[10px] border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none shadow-sm bg-white"
                          required
                        >
