    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.figure
          ...
          className="absolute top-8 left-1/4 opacity-10 hidden sm:block will-change-transform"
        >
        ...
        <motion.figure
          ...
          className="absolute bottom-8 right-1/4 opacity-10 hidden sm:block will-change-transform"
        >
      ...
      <div className="container relative z-10 px-4">
        ...
        >
          ...
          <motion.p
            ...
            transition={{ delay: 0.3, duration: prefersReducedMotion ? 0 : 0.4 }}
            viewport={{ once: true }}
          ...
          >
            Sign up for updates, offers, and STEM resources.          </motion.p>

          {/* Form */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.4, duration: prefersReducedMotion ? 0 : 0.4 }}
            viewport={{ once: true }}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-32 h-0.5 mx-auto mt-8 sm:mt-10 will-change-transform"
